...
export const artists: Artist[] = [
  ...
  {
    id: 'c-ashwath',
    name: { kn: 'ಸಿ. ಅಶ್ವತ್ಥ್', en: 'C. Ashwath' },
    blurb: {
      kn: 'ಕನ್ನಡ ಸುಗಮ ಸಂಗೀತದ ದೊಡ್ಡ ಹೆಸರು. ಕವಿತೆಯನ್ನ ಎತ್ತಿಕೊಂಡು ಎಲ್ಲರೂ ಗುನುಗುವಂತೆ ಮಾಡಿದವರು.',
      en: 'A giant of Kannada sugama sangeetha, who took poems off the page and left them where everyone could hum them.',
    },
    links: { wikipedia: 'https://en.wikipedia.org/wiki/C._Ashwath' },
  },
  {
    id: 'ratnamala-prakash',
    name: { kn: 'ರತ್ನಮಾಲಾ ಪ್ರಕಾಶ್', en: 'Ratnamala Prakash' },
  },
  {
    id: 'ks-narasimhaswamy',
    name: { kn: 'ಕೆ.ಎಸ್. ನರಸಿಂಹಸ್ವಾಮಿ', en: 'K.S. Narasimhaswamy' },
    blurb: {
      kn: 'ಮೈಸೂರ ಮಲ್ಲಿಗೆಯ ಕವಿ. ಸಂಸಾರದ ಸಣ್ಣ ಸಣ್ಣ ಸಂಗತಿಗಳನ್ನೇ ಕವಿತೆ ಮಾಡಿದವರು.',
      en: 'The poet of Mysooru Mallige, who made poetry out of the smallest domestic things.',
    },
    links: { wikipedia: 'https://en.wikipedia.org/wiki/K._S._Narasimhaswamy' },
  },
  {
    id: 'mysore-ananthaswamy',
    name: { kn: 'ಮೈಸೂರು ಅನಂತಸ್ವಾಮಿ', en: 'Mysore Ananthaswamy' },
    blurb: {
      kn: 'ಕನ್ನಡ ಭಾವಗೀತೆಯ ಮೊದಲಿಗರಲ್ಲಿ ಒಬ್ಬರು. ನಿತ್ಯೋತ್ಸವ ಎಂಬ ಮೊದಲ ಭಾವಗೀತೆ ಸಂಗ್ರಹ ಇವರದೇ.',
      en: 'One of the founders of Kannada bhavageethe, and the composer of Nityotsava, the first album the form had.',
    },
    links: { wikipedia: 'https://en.wikipedia.org/wiki/Mysore_Ananthaswamy' },
  },
  {
    id: 'raju-ananthaswamy',
    name: { kn: 'ರಾಜು ಅನಂತಸ್ವಾಮಿ', en: 'Raju Ananthaswamy' },
    blurb: {
      kn: 'ಮೈಸೂರು ಅನಂತಸ್ವಾಮಿಯವರ ಮಗ. ಇನ್ನೂರಕ್ಕೂ ಹೆಚ್ಚು ಕವಿತೆಗಳಿಗೆ ರಾಗ ಕಟ್ಟಿ, ಅಪ್ಪನ ಹಾದಿಯನ್ನ ಮುಂದುವರಿಸಿದವರು.',
      en: 'Mysore Ananthaswamy\u2019s son, who set more than two hundred poems to tune and carried his father\u2019s line forward.',
    },
    links: { wikipedia: 'https://en.wikipedia.org/wiki/Raju_Ananthaswamy' },
  },
  {
    id: 'tp-kailasam',
    name: { kn: 'ಟಿ.ಪಿ. ಕೈಲಾಸಂ', en: 'T.P. Kailasam' },
    blurb: {
      kn: 'ಕನ್ನಡ ರಂಗಭೂಮಿಯ ಪ್ರಹಸನಕಾರ. ಆಡುಮಾತನ್ನೇ ಸಾಹಿತ್ಯ ಮಾಡಿದವರು, ನಗಿಸುತ್ತಲೇ ಚುಚ್ಚಿದವರು.',
      en: 'The playwright who made literature out of everyday Kannada speech, and did his sharpest work while making people laugh.',
    },
    links: { wikipedia: 'https://en.wikipedia.org/wiki/T._P._Kailasam' },
  },
  {
    id: 'gs-shivarudrappa',
    name: { kn: 'ಜಿ.ಎಸ್. ಶಿವರುದ್ರಪ್ಪ', en: 'G.S. Shivarudrappa' },
    blurb: {
      kn: 'ರಾಷ್ಟ್ರಕವಿ. ಎದೆ ತುಂಬಿ ಹಾಡಿದೆನು ಎಂಬ ಸಾಲು ಇವರದೇ.',
      en: 'A Rashtrakavi, and the man who wrote the line Ede Tumbi Haadidenu.',
    },
    links: { wikipedia: 'https://en.wikipedia.org/wiki/G._S._Shivarudrappa' },
  },
  {
    id: 'gp-rajaratnam',
    name: { kn: 'ಜಿ.ಪಿ. ರಾಜರತ್ನಂ', en: 'G.P. Rajaratnam' },
    blurb: {
      kn: 'ರತ್ನನ ಪದಗಳ ಕವಿ. ಕುಡುಕನ ಬಾಯಲ್ಲಿ ಕನ್ನಡದ ಪ್ರೀತಿಯನ್ನ ಹಾಡಿಸಿದವರು.',
      en: 'The poet of Ratnana Padagalu, who put the love of Kannada in the mouth of a drunkard and made it stick.',
    },
    links: { wikipedia: 'https://en.wikipedia.org/wiki/G._P._Rajarathnam' },
  },
  {
    id: 'masti-venkatesha-iyengar',
    name: { kn: 'ಮಾಸ್ತಿ ವೆಂಕಟೇಶ ಅಯ್ಯಂಗಾರ್', en: 'Masti Venkatesha Iyengar' },
    blurb: {
      kn: 'ಕನ್ನಡದ ಸಣ್ಣಕಥೆಯ ಪಿತಾಮಹ, ಜ್ಞಾನಪೀಠ ಪಡೆದವರು.',
      en: 'The father of the Kannada short story, and a Jnanpith laureate.',
    },
    links: { wikipedia: 'https://en.wikipedia.org/wiki/Masti_Venkatesha_Iyengar' },
  },
]
...
export const songs: Song[] = [
  ...
  {
    // From the Mysooru Mallige album, not the 1992 film of the same name that reused the same poems.
    id: 'mysore-mallige',
    title: 'Mysore Mallige',
    titleKn: 'ಮೈಸೂರ ಮಲ್ಲಿಗೆ',
    youtubeId: 'DDXKii0iIFc',
    credits: [
      { artist: 'c-ashwath' },
      { artist: 'ratnamala-prakash', role: 'featured' },
      { artist: 'ks-narasimhaswamy', role: 'words' },
    ],
    genres: ['bhavageethe'],
    moods: ['longing', 'latenight'],
    childSafe: true,
  ...
  {
    id: 'modala-dina-mouna',
    title: 'Modala Dina Mouna',
    titleKn: 'ಮೊದಲ ದಿನ ಮೌನ',
    youtubeId: 'XA7p3DVpG0U',
    credits: [
      { artist: 'c-ashwath' },
      { artist: 'ratnamala-prakash', role: 'featured' },
      { artist: 'ks-narasimhaswamy', role: 'words' },
  ...
  {
    id: 'ondirulu-kanasinali',
    title: 'Ondirulu Kanasinali',
    titleKn: 'ಒಂದಿರುಳು ಕನಸಿನಲಿ',
    youtubeId: 'FfjR5pT3aik',
    credits: [
      { artist: 'c-ashwath' },
      { artist: 'ratnamala-prakash', role: 'featured' },
      { artist: 'ks-narasimhaswamy', role: 'words' },
  ...
  {
    id: 'raayaru-bandaru',
    title: 'Raayaru Bandaru',
    titleKn: 'ರಾಯರು ಬಂದರು',
    youtubeId: 'LjpY69_PKhQ',
    credits: [
      { artist: 'c-ashwath' },
      { artist: 'ratnamala-prakash', role: 'featured' },
      { artist: 'ks-narasimhaswamy', role: 'words' },
  ...
  {
    id: 'balegara-chennayya',
    title: 'Balegara Chennayya',
    titleKn: 'ಬಳೆಗಾರ ಚೆನ್ನಯ್ಯ',
    youtubeId: '1xmF0dQRzdg',
    credits: [
      { artist: 'c-ashwath' },
      { artist: 'ratnamala-prakash', role: 'featured' },
      { artist: 'ks-narasimhaswamy', role: 'words' },
  ...
  {
    id: 'baare-nanna-shaarade',
    title: 'Baare Nanna Shaarade',
    titleKn: 'ಬಾರೆ ನನ್ನ ಶಾರದೆ',
    youtubeId: 'BYkKkNJP7hs',
    credits: [
      { artist: 'c-ashwath' },
      { artist: 'ratnamala-prakash', role: 'featured' },
      { artist: 'ks-narasimhaswamy', role: 'words' },
  ...
  {
    id: 'ninnolumeyindale',
    title: 'Ninnolumeyindale',
    titleKn: 'ನಿನ್ನೊಲುಮೆಯಿಂದಲೆ',
    youtubeId: 'uRNiwGzZmtI',
    credits: [
      { artist: 'c-ashwath' },
      { artist: 'ratnamala-prakash', role: 'featured' },
      { artist: 'ks-narasimhaswamy', role: 'words' },
  ...
  {
    id: 'ninna-premada-pariya',
    title: 'Ninna Premada Pariya',
    titleKn: 'ನಿನ್ನ ಪ್ರೇಮದ ಪರಿಯ',
    youtubeId: 'fz_2_jZyutI',
    credits: [
      { artist: 'c-ashwath' },
      { artist: 'ratnamala-prakash', role: 'featured' },
      { artist: 'ks-narasimhaswamy', role: 'words' },
  ...
  {
    // Kailasam's Kolike Ranga, in the spoken Kannada he wrote everything in.
    id: 'nan-huttiddu',
    title: 'Nan Huttiddu (Kolike Ranga)',
    titleKn: 'ನಾನ್ ಹುಟ್ಟಿದ್ದು',
    youtubeId: '3Xb7DSzraOs',
    credits: [{ artist: 'mysore-ananthaswamy' }, { artist: 'tp-kailasam', role: 'words' }],
    genres: ['bhavageethe', 'folk'],
    moods: ['joy'],
    childSafe: true,
  },
  {
    id: 'ede-tumbi-haadidenu',
    title: 'Ede Tumbi Haadidenu',
    titleKn: 'ಎದೆ ತುಂಬಿ ಹಾಡಿದೆನು',
    youtubeId: 'H-99yoLymF8',
    credits: [{ artist: 'raju-ananthaswamy' }, { artist: 'gs-shivarudrappa', role: 'words' }],
    genres: ['bhavageethe'],
    moods: ['focus', 'joy'],
    childSafe: true,
  },
  {
    id: 'ene-barali-enthe-irali',
    title: 'Ene Barali Enthe Irali',
    titleKn: 'ಏನೇ ಬರಲಿ ಎಂತೇ ಇರಲಿ',
    youtubeId: 'VWsQLgJlCUI',
    credits: [
      { artist: 'raju-ananthaswamy' },
      { artist: 'masti-venkatesha-iyengar', role: 'words' },
    ],
    genres: ['bhavageethe'],
    moods: ['focus', 'longing'],
    childSafe: true,
  },
  {
    id: 'inor-holdalli',
    title: 'Inor Holdalli',
    titleKn: 'ಇನ್ನೊರ್ ಹೊಲ್ದಲ್ಲಿ',
    youtubeId: 'fIqGFgorAjw',
    credits: [{ artist: 'raju-ananthaswamy' }, { artist: 'gp-rajaratnam', role: 'words' }],
    genres: ['bhavageethe'],
    moods: ['restless'],
  },
  {
    // From Ratnana Padagalu, which is sung in the voice of a drunkard and is not a family listen.
    id: 'yenda-yedathi',
    title: 'Yenda Yedathi Kannada Padgol',
    titleKn: 'ಎಂಡ ಎಡ್ತಿ ಕನ್ನಡ ಪದಗೋಳ್',
    youtubeId: 'DAXMtd7ilas',
    credits: [{ artist: 'raju-ananthaswamy' }, { artist: 'gp-rajaratnam', role: 'words' }],
    genres: ['bhavageethe'],
    moods: ['joy', 'restless'],
  },
  {
    // The same Rajaratnam verse Lagori later cut for a film. This is the bhavageethe.
    id: 'helkolakondooru-raju',
    title: 'Helkolakondooru',
    titleKn: 'ಹೇಳ್ಕೊಳ್ಳಾಕೊಂದೂರು',
    youtubeId: 'WNqaoEPlHyk',
    credits: [{ artist: 'raju-ananthaswamy' }, { artist: 'gp-rajaratnam', role: 'words' }],
    genres: ['bhavageethe'],
    moods: ['road', 'joy'],
  },
  {
    id: 'beladhingala-rathrili',
    title: 'Beladhingala Rathrili',
    titleKn: 'ಬೆಳ್ದಿಂಗಳ ರಾತ್ರೀಲಿ',
    youtubeId: '5uReyL6465Y',
    credits: [{ artist: 'raju-ananthaswamy' }, { artist: 'gp-rajaratnam', role: 'words' }],
    genres: ['bhavageethe'],
    moods: ['latenight'],
  },
  {
    // The upload does not name the poet, so none is credited here.
    id: 'badavanadare-yenu-priye',
    title: 'Badavanadare Yenu Priye',
    titleKn: 'ಬಡವನಾದರೆ ಏನು ಪ್ರಿಯೆ',
    youtubeId: 'sSwPbmABlsU',
    credits: [{ artist: 'raju-ananthaswamy' }, { artist: 'c-ashwath', role: 'with' }],
    genres: ['bhavageethe'],
    moods: ['longing'],
    childSafe: true,
  },
